<div class="bg-slate-200 p-3">
    <div class="flex justify-between">
        <div>
            <!-- <a class="inline-block transform rounded-lg bg-yellow-500 px-5 py-3 text-sm font-semibold uppercase tracking-wider text-white shadow-lg transition hover:-translate-y-0.5 hover:bg-blue-400 focus:outline-none focus:ring focus:ring-blue-500 focus:ring-opacity-50 focus:ring-offset-2 active:bg-blue-900 sm:text-base" href="{{ route('home') }}">Users</a>
