...
@section('content')
    <div class="card">
        ...
        <div class="pt-5 px-9">
            ...
            <a class="inline-block mb-3 px-5 py-3 rounded-lg transform transition bg-green-800 hover:bg-green-400 hover:-translate-y-0.5 focus:ring-green-500 focus:ring-opacity-50 focus:outline-none focus:ring focus:ring-offset-2 active:bg-blue-900 uppercase tracking-wider font-semibold text-sm text-white shadow-lg sm:text-base"
                href="subjects/create">Add a Subject</a>
