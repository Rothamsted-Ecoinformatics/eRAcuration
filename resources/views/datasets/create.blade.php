...
@section('content')
    <div class="card">
        <div class="card-header bg-blue-600 text-center">
            <h1 class="text-4xl text-slate-100 text-bold justify-center p-9 ">Add a Dataset or Document</h1>
        </div>
        <div class="card-body">
                    ...
                    <div class="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6 items-start">
                        <div class="grid grid-cols-1 gap-6">
                            ...
                            <label class="block">
                                ...
                                <select class="form-select block w-full mt-1  rounded-md" name="lte_id">
                                    ...
                                    <option value="{{ $experiment -> experiment_id }}">{{ $experiment -> experiment_name }} ({{ $experiment -> experiment_code }})</option>
                                    @endforeach
                                </select>
                            </label>
                        ...
                        <div class="grid grid-cols-1 gap-6">
                            ...
                            <label class="block">
                                ...
                                <select class="select2-multiple form-control block w-full mt-1   rounded-md" multiple="subjects"
                                    name="subjects">
                            ...
                            <label class="block">
                                ...
                                <p>Here I suggest having a table with the dates already created, and a button to add another dates. When updated, automatic updated date added</p>
                            </label>
                ...
                <div class="max-w-4xl mx-auto py-12">
                    ...
                    <label class="block">
                        ...
                        <textarea class="form-textarea mt-1 block w-full h-24  rounded-md" rows="4" placeholder="This is Compulsory"
                            name="description_abstract"></textarea>
                    </label>
                    ...
                    <label class="block">
                        ...
                        <textarea class="form-textarea mt-1 block w-full h-24  rounded-md" rows="4" placeholder=""
                            name="description_other"></textarea>
                    </label>

                    <h2 class="text-2xl font-bold">Associated Documents</h2>
                    <p>Here I suggest having a table with the Documents already associated, and a button to add another one. </p>
